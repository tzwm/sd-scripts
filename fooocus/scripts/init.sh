...
if [ ! -d "$target_model_dir/checkpoint" ]; then
  ...
  cg down tzwm/StableDiffusion-checkpoints/animaPencilXL_v500.safetensors
  cg down tzwm/StableDiffusion-checkpoints/juggernautXL_v8Rundiffusion.safetensors
  cg down tzwm/StableDiffusion-checkpoints/realisticStockPhoto_v20.safetensors
